...
namespace Microsoft.Build.UnitTests.Evaluation
{
    ...
    public class ImportFromMSBuildExtensionsPathTests : IDisposable
    {
        ...
        public void ImportFromExtensionsPathNotFound()
        {
            ...
            string extnDir2 = null;
            string mainProjectPath = null;

            try {
                extnDir1 = GetNewExtensionsPathAndCreateFile("extensions1", Path.Combine("foo", "extn.proj"), GetExtensionTargetsFileContent1());
                extnDir2 = GetNewExtensionsPathAndCreateFile("extensions2", Path.Combine("bar", "extn2.proj"), GetExtensionTargetsFileContent2());
                ...
                logger.AssertLogContains(String.Format(
                            MockLogger.GetString("ImportedProjectNotFound"),
                            Path.Combine("$(MSBuildExtensionsPath)", "bar", "extn2.proj")));
            } finally {
